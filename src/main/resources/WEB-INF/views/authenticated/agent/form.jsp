...
<acme:form>
	...
	<acme:input-textarea code="authenticated.agent.form.label.languages" path="languages"/>
	<acme:input-moment code="authenticated.agent.form.label.moment" path="moment"/>
	<acme:input-textarea code="authenticated.agent.form.label.bio" path="bio"/>
	...
	<acme:input-select code="authenticated.agent.form.label.airline" path="airline" choices="${airlines}"/>
