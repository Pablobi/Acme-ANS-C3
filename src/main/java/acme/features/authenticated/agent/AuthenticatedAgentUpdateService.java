...
@GuiService
public class AuthenticatedAgentUpdateService extends AbstractGuiService<Authenticated, Agent> {
	...
	public void load() {
		...
		object = this.repository.findAgentByUserAccountId(userAccountId);
