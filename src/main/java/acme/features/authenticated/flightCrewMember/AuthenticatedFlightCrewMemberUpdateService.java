...
public class AuthenticatedFlightCrewMemberUpdateService extends AbstractGuiService<Authenticated, FlightCrewMember> {
	...
	public void load() {
		...
		FlightCrewMember flightCrewMember = this.repository.findFlightCrewMemberByUserId(userId);
	...
	public void bind(final FlightCrewMember flightCrewMember) {
		...
		super.bindObject(flightCrewMember, "phoneNumber", "languageSkills", "salary", "yearsOfExperience", "availabilityStatus");
	}
